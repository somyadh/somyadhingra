...
function CV() {
  return (
    <div className="OUTERDIV">
      ...
      <p className="FULLNAME"><strong>Somya Dhingra</strong></p>
      <p className="ROLE">Backend Developer</p>
      <div className="EXPDETAIL">
        <p className="SECTION_HEADING">Experience</p>
        <EXPERIENCE role={`SOFTWARE DEVELOPER II `} companyName={`LEAD SCHOOL `} timeLine={`FEBRUARY,2022 – PRESENT, Bengaluru`}
...
`}
        />
        <EXPERIENCE role={`SOFTWARE DEVELOPER`} companyName={`PINGSPACE `} timeLine={`JULY,2020-JANUARY,2022, Penang`}
        ...
        />
        <EXPERIENCE role={`SDET `} companyName={`CISCO`} timeLine={`MAY,2018-DECEMBER,2019, Bengaluru`}
        ...
        />
        <EXPERIENCE role={`SDET `} companyName={`WIPRO TECHNOLOGIES`} timeLine={`AUGUST,2015-APRIL,2018, Bengaluru`}
        ...
        <EXPERIENCE role={`BACHELOR OF TECHNOLOGY- ELECTRONICS AND INSTRUMENTATION`} companyName={`MEERUT INSTITUTE OF ENGINEERING AND TECHNOLOGY`} timeLine={`2011-2015 , MEERUT`}
        />
      </div>
      <div className="right-column">
        <SIDEBAR contact={`som.dhingra@yahoo.in
Bengaluru, India`} industryKnowledge={`Product Design
API Design
`} toolsAndTechnologies={`Node.JS
Javascript
PostgreSQL
Python
Redis
...
WebSocket
RabbitMq`}
          otherSkills={`ReactJS, Angular JS`} socials={`linkedin.com/in/somyadhingra
          github.com/somyadh`} />
      </div>
    </div>
  );
